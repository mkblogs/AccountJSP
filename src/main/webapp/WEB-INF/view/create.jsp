  ...
  <div class="container">
    <div class="card card-outline-secondary">
      <div class="card-header">
       ...
       <div class="card-body">
           <form:form class="form"  action="create" modelAttribute="accountDTO" method="post" autocomplete="off">
             ...
             <div class="form-group row">
                  ...
                  <div class="col-6">
                    <form:errors path="name" cssClass="alert alert-danger p-0" />                                   
                  </div>
              </div>
              <div class="form-group row">
                ...
                <div class="col-6">
                    <form:errors path="type" cssClass="alert alert-danger p-0" />  
                </div>
            </div>
            <div class="form-group row">
              ...
              <div class="col-6">
                <form:errors path="amount" cssClass="alert alert-danger p-0" />  
              </div>
          </div>
          <div class="form-group row">
